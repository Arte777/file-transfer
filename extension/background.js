...
async function createRobloxGamepass(universeId, name, price, csrfToken) {
  ...
  const data = await r.json();
  console.log('✅ Created gamepass:', data.gamePassId, 'price:', price);
      ...
      try {
        ...
        for (const p of prices) {
          try {
            ...
            const passId = await createRobloxGamepass(universeId, gpName, p, csrf);
            if (passId) {
