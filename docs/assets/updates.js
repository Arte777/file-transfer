...
const UPDATES = [
  {
    ...
    changes: [
      ...
      { type: "add", text: "Сборка полноценных инсталляторов Setup (.exe) на базе Inno Setup: создание ярлыка на Рабочий стол, интеграция в систему, деинсталлятор и сжатие LZMA2" },
      { type: "add", text: "Новый современный тёмный молодёжный дизайн билдера: безрамочное стекло, неоновые акценты, карточки действий и интерактивная консоль" },
      ...
      { type: "fix", text: "Исправлена установка и сброс фото аватарок операторов: поддержка больших изображений и мгновенное сохранение в профиле" },
