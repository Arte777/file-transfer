...
function renderHeader(activePage) {
  ...
  const iconAi = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7v5a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-5a7 7 0 0 1 7-7h1V5.73A2 2 0 0 1 9 4a2 2 0 0 1 2-2z"></path><path d="M8 12h.01M16 12h.01"></path></svg>`;
  ...
  return `<aside class="sidebar">
    ...
    <div class="nav-links">
      ...
      ${navLink('ai', 'ai.html', iconAi, 'ИИ Ассистент')}
